...
public class Mesh {
	...
	private ByteBuffer IndeciesDataBuffer;
	private int vboId;
	private int iboId;
	private int vaoId;
	private int size;
	...
	public Mesh(float[] vertecies, int[] indecies) {
	...
	public Mesh(ByteBuffer vertecies, ByteBuffer indecies) {
...
//	}
	...
	public ByteBuffer getIndeciesDataBuffer() {
		return IndeciesDataBuffer;
	}
	public void setIndeciesDataBuffer(ByteBuffer indeciesDataBuffer) {
		IndeciesDataBuffer = indeciesDataBuffer;
	}
	public int getSize() {
		return size;
	}
